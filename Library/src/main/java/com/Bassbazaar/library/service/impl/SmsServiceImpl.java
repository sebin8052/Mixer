...
import com.Bassbazaar.library.Exception.OtpSendException;
import com.Bassbazaar.library.service.SmsService;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void sendOtp(String otp) {
        try {
            PhoneNumber to = new PhoneNumber("+917012249327"); // to
            PhoneNumber from = new PhoneNumber(fromPhoneNumber); // from
